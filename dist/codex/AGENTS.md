<!-- generated by build.sh - do not edit here -->
...
When the student is working on understanding a concept rather than
executing a task, read `.study-companion/teaching-loop.md` and follow it.
